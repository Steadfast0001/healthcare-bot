    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(18),
          border: Border.all(color: const Color(0xFF2A6AF6).withValues(alpha: 0.4)),
        ),
        padding: const EdgeInsets.all(14),
        child: Row(children: [
          Expanded(
                  ...
                  TweenAnimationBuilder<double>(
                    ...
                    builder: (context, val, child) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: Colors.green.withValues(alpha: (2.0 - val) * 0.15),
                        ),
                      );
                    },
                  ),
              ...
              children: [
                IconButton(
                  ...
                  style: IconButton.styleFrom(
                    backgroundColor: _muted ? Colors.redAccent.withValues(alpha: 0.15) : Colors.white.withValues(alpha: 0.05),
                ...
                IconButton(
                  ...
                  style: IconButton.styleFrom(
                    backgroundColor: isVideo
                        ? (_videoOff ? Colors.redAccent.withValues(alpha: 0.15) : Colors.white.withValues(alpha: 0.05))
